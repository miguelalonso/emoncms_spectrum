<?php
    ...
    */
    ...
    if ($route->controller == 'spectrum' && $route->action == 'post') $route->format = 'json';
    if ($route->controller == 'spectrum' && $route->action == 'bulk') $route->format = 'json';
    ...
    if ($route->format == 'json')
    {
        ...
        if ($route->controller=='time') {
            ...
            print $output['content'];
        } elseif ($route->controller=='spectrum' && $route->action=='post') {
            print $output['content'];
        } elseif ($route->controller=='spectrum' && $route->action=='bulk') {
            print $output['content'];
        } else {
