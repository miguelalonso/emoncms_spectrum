...
function cylinder_widgetlist()
{
  var widgets = {
    "cylinder":
    {
      ...
      "menu":"Widgets",
      "options":["topfeedspectrum","botfeedspectrum"],
      "optionstype":["feedspectrum","feedspectrum"],
      "optionsname":[_Tr("feedspectrum"),_Tr("feedspectrum")],
      "optionshint":[_Tr("Top feedspectrum value"),_Tr("Bottom feedspectrum value")]
    }
  }
  return widgets;
}
...
function cylinder_draw()
{
  ...
  {
    var cyl_top = assoc[$(this).attr("topfeedspectrum")]*1;
    var cyl_bot = assoc[$(this).attr("botfeedspectrum")]*1;
