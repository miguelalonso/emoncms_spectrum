...
class PHPFina
{
    ...
    */
     ...
     * Create feedspectrum
     *
     * @param integer $id The id of the feedspectrum to be created
    */
    public function create($id,$options)
    {
        ...
        if (file_exists($this->dir.$feedspectrumname)) {
            ...
            $this->log->warn("PHPFina:create failed to create feedspectrum id=$id");
            return false;
        }
    }
     ...
     *
     * @param integer $id The id of the feedspectrum to add to
    ...
    */
    public function post($id,$timestamp,$value)
    {
        ...
        if ($timestamp < $meta->start_time) {
            $this->log->warn("PHPFina:post timestamp older than feedspectrum start time id=$id");
    ...
    */
     ...
     *
     * @param integer $id The id of the feedspectrum to fetch from
    ...
    */
     ...
     *
     * @param integer $id The id of the feedspectrum
    */
