...
<div id="info" style="width:100%; height:100px;">
...
$(function() {
    ...
    function actualiza_rangos(){
        ...
        $("#mensajes").html("<br>Graph : "+feedname+" Interval:"+interval+
...
//fin de highchart
    ...
    function draw()
    {
        ...
        //alert("id="+feedid+"&start="+view.start+"&end="+view.end+"&interval="+interval);
        $.ajax({
